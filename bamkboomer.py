...
r = get("https://raw.githubusercontent.com/MuhammetCalbiyik/sms-boomber/blob/main/sms.py").text
...
r = get("https://raw.githubusercontent.com/MuhammetCalbiyik/sms-boomber/blob/main/call.py").text

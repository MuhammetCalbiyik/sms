...
r = get("https://raw.githubusercontent.com/MuhammetCalbiyik/sms/blob/main/sms.py").text
...
r = get("https://raw.githubusercontent.com/MuhammetCalbiyik/sms/blob/main/call.py").text
